 ...
 */
final class Version20251229215409 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ext_translations (id INT AUTO_INCREMENT NOT NULL, locale VARCHAR(8) NOT NULL, object_class VARCHAR(191) NOT NULL, field VARCHAR(32) NOT NULL, foreign_key VARCHAR(64) NOT NULL, content LONGTEXT DEFAULT NULL, UNIQUE INDEX lookup_unique_idx (foreign_key, locale, object_class, field), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 ROW_FORMAT = DYNAMIC');
        ...
        $this->addSql('ALTER TABLE users ADD is_verified TINYINT DEFAULT 0 NOT NULL, CHANGE role role ENUM(\'customer\',\'admin\',\'editor\',\'logistics\')');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users DROP is_verified, CHANGE role role ENUM(\'customer\', \'admin\', \'editor\', \'logistics\') DEFAULT NULL');
    }
}
